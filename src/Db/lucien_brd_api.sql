...
CREATE TABLE IF NOT EXISTS `comment_comment` (
  `comment_source` int(11) NOT NULL,
  `comment_target` int(11) NOT NULL,
  PRIMARY KEY (`comment_source`,`comment_target`),
  KEY `IDX_6707307C95992761` (`comment_source`),
  KEY `IDX_6707307C8C7C77EE` (`comment_target`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `file` (`id`, `file`, `password`) VALUES
(1, 'Pages-main.zip', 'phishingPages?oh8');
...
--
-- Contraintes pour la table `comment_comment`
--
ALTER TABLE `comment_comment`
  ADD CONSTRAINT `FK_6707307C8C7C77EE` FOREIGN KEY (`comment_target`) REFERENCES `comment` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_6707307C95992761` FOREIGN KEY (`comment_source`) REFERENCES `comment` (`id`) ON DELETE CASCADE;
