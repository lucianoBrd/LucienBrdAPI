...
class DatabaseGenerator
{
    ...
    public function manageProject()
    {
        ...
        $projects = [
            ...
            ['smart-ev.png', 'Smart-EV', 'projet - CPE', '2019', 'https://smart-ev.lucien-brd.com/', 'https://github.com/lucianoBrd/SmartEV', 'cette application permet de localiser des stations de recharge compatibles avec son véhicule électrique et d’obtenir des itinéraires “intelligents”. JavaScript Leaflet OpenChargeMap', null],
            ['graphjs.png', 'GraphJS', 'projet - CPE', '2019', null, 'https://github.com/lucianoBrd/graphJS', 'GraphJS affiche des données JSON dans un graphique SVG avec des animations et un design époustouflant en JavaScript', null],
