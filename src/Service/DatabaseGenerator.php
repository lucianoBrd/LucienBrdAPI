...
class DatabaseGenerator
{
    ...
    public function manageProject()
    {
        ...
        $projects = [
            ['emilie-nguyen.png', '@ngyemilie', 'site vitrine - Freelance', '2017', 'https://emilie-nguyen.com/', 'https://github.com/lucianoBrd/EmilieNguyen', 'site pour une photographe en symfony 4', null],
            ['yosagaf.png', 'sagaf youssouf', 'site vitrine - Freelance', '2019', 'https://yosagaf.fr/', 'https://github.com/lucianoBrd/Sagaf', 'site pour un développeur de systèmes embarqués en symfony 4', null],
            ['smart-ev.png', 'Smart-EV', 'projet - CPE', '2020', 'https://smart-ev.lucien-brd.com/', 'https://github.com/lucianoBrd/SmartEV', 'cette application permet de localiser des stations de recharge compatibles avec son véhicule électrique et d’obtenir des itinéraires “intelligents”. JavaScript Leaflet OpenChargeMap', null],
            ['graphjs.png', 'GraphJS', 'projet - CPE', '2020', null, 'https://github.com/lucianoBrd/graphJS', 'GraphJS affiche des données JSON dans un graphique SVG avec des animations et un design époustouflant en JavaScript', null],
            ['snakejs.png', 'Crazy Snake', 'projet - IUT', '2018', null, 'https://github.com/lucianoBrd/SnakeJs', 'Crazy Snake pour des parties de folie. Jeu du snake fait en javascript, html et css', null],
